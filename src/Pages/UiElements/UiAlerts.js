...
const UiAlerts = () => {
  document.title = "Alerts | Optioutlet";

  return (
    <React.Fragment>
        <div className="page-content">
          <Container fluid={true}>
            <Breadcrumbs title="UI Elements" breadcrumbItem="Alerts" iconSection="Components" dropdownSubitem = {true}/>
                ...
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      ...
                      (e.g., <code>.alert-success</code>). For inline dismissal, use the alerts jQuery plugin.
                    </p>
